import * as ADD from '@redis/time-series/dist/commands/ADD';
import * as ALTER from '@redis/time-series/dist/commands/ALTER';
import * as CREATE from '@redis/time-series/dist/commands/CREATE';
import * as CREATERULE from '@redis/time-series/dist/commands/CREATERULE';
import * as DECRBY from '@redis/time-series/dist/commands/DECRBY';
import * as DEL from '@redis/time-series/dist/commands/DEL';
import * as DELETERULE from '@redis/time-series/dist/commands/DELETERULE';
import * as GET from '@redis/time-series/dist/commands/GET';
import * as INCRBY from '@redis/time-series/dist/commands/INCRBY';
import * as INFO_DEBUG from '@redis/time-series/dist/commands/INFO_DEBUG';
import * as INFO from '@redis/time-series/dist/commands/INFO';
import * as MADD from '@redis/time-series/dist/commands/MADD';
import * as MGET from '@redis/time-series/dist/commands/MGET';
import * as MGET_WITHLABELS from '@redis/time-series/dist/commands/MGET_WITHLABELS';
import * as QUERYINDEX from '@redis/time-series/dist/commands/QUERYINDEX';
import * as RANGE from '@redis/time-series/dist/commands/RANGE';
import * as REVRANGE from '@redis/time-series/dist/commands/REVRANGE';
import * as MRANGE from '@redis/time-series/dist/commands/MRANGE';
import * as MRANGE_WITHLABELS from '@redis/time-series/dist/commands/MRANGE_WITHLABELS';
import * as MREVRANGE from '@redis/time-series/dist/commands/MREVRANGE';
import * as MREVRANGE_WITHLABELS from '@redis/time-series/dist/commands/MREVRANGE_WITHLABELS';
